        ...
        >
            <div className="group h-full bg-white border border-warm-200/80 rounded-lg overflow-hidden transition-all duration-400 hover:border-warm-300">
                ...
                <div className="p-3 md:p-5">
                    <Link href={`/products/${productSlug}`}>
                        <h3 className="font-serif text-sm md:text-xl text-warm-800 mb-1 md:mb-2 line-clamp-2 min-h-[2.5rem] md:min-h-[3.5rem] hover:text-maroon-600 transition-colors cursor-pointer">
                            {productTitle}
                        </h3>
                    </Link>

                    <p className="hidden md:block text-sm text-warm-500 leading-relaxed mb-4 line-clamp-1">
                        {product.description}
                    </p>

                    {/* Product code on mobile, Request Quote on desktop */}
                    <div className="md:hidden text-xs text-warm-500 mb-2">
                        {product.code}
                    </div>
                    ...
                    <a
                        ...
                        className="hidden md:inline-flex items-center justify-center w-full px-4 py-2.5 text-sm font-medium text-warm-700 border border-warm-200 rounded hover:bg-warm-50 hover:border-warm-300 hover:text-maroon-600 transition-all duration-300"
                    >
