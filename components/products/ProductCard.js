            ...
            <div className="group h-full bg-white border border-warm-200/80 rounded-lg overflow-hidden transition-all duration-400 hover:border-warm-300">
                ...
                <div className="p-3 md:p-5">
                    ...
                    <a
                        ...
                        className="hidden md:inline-flex items-center justify-center w-full px-4 py-2.5 text-sm font-medium text-warm-700 border border-warm-200 rounded opacity-0 group-hover:opacity-100 hover:bg-warm-50 hover:border-warm-300 hover:text-maroon-600 transition-all duration-300"
                    >
