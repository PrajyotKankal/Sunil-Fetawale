            ...
            <div className="relative container-custom section-spacing">
                ...
                >
                    ...
                    >
                        ...
                        <Link
                            href="/products"
                            className="inline-flex items-center space-x-2 px-6 py-3 md:px-8 md:py-4 bg-maroon-600 text-white rounded-lg font-medium text-sm md:text-base hover:bg-maroon-700 transition-colors duration-350 min-w-0 md:min-w-[200px] justify-center shadow-lg hover:shadow-maroon-900/30 hover:shadow-2xl"
                        >
